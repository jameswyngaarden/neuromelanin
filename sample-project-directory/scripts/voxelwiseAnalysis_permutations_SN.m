...
cluster_size_result05 = [];
cluster_size_direction =[];%1=positive direction, 0=negative direction
...
LowVox = -8.8257; %this excludes voxels with CNR value below -8% (if the switch exc_vox=1). These likely should be modified in a study specific manner based on the distribution of all voxels in all subjects
HiVox = 24.7862; %this excludes voxels with CNR above 24.7862%.
