...
%Additional comments added by Jimmy Wyngaarden (james.wyngaarden@temple.edu), June 2021
...
% establish project directory as root folder
root_folder = ('.../sample-project-directory/data/');

% list subjects to be used in analysis
Subs = [1001, 1002, 1003];

% reference TPM.nii image from your spm dir:
existing_template=1;
templatedir= '.../sample-project-directory/templates/';
...
% locate NM and T1w images in project directory:
for s = 1:length(Subs)
